...
powershell -Command "(Get-Content 'src\app\theme-2\profil\logo-maskot\page.tsx') -replace 'import \{ Header \} from ''@/components/header'';', '' | Set-Content 'src\app\theme-2\profil\logo-maskot\page.tsx'"
powershell -Command "(Get-Content 'src\app\theme-2\profil\logo-maskot\page.tsx') -replace 'import \{ Footer \} from ''@/components/footer'';', '' | Set-Content 'src\app\theme-2\profil\logo-maskot\page.tsx'"
