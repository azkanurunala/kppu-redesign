      ...
      <main className="flex-1">
        ...
        >
          ...
          <div className="container mx-auto px-4 relative text-center">
            <h1 className="text-5xl md:text-7xl font-bold font-poppins">Indeks Persaingan Usaha</h1>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="lg:pr-12">
                ...
                <p className="text-4xl lg:text-5xl font-bold text-primary-dark dark:text-white font-poppins mb-8">Apa Itu Indeks Persaingan Usaha?</p>
        ...
        <section className="py-24 lg:py-32 bg-card">
          <div className="container mx-auto px-4">
            <div className="text-center mb-20">
              ...
              <p className="text-4xl lg:text-5xl font-bold text-primary-dark dark:text-white font-poppins">Perkembangan Skor IPU Nasional</p>
            </div>
        ...
        <section className="py-24 lg:py-32">
            <div className="container mx-auto px-4">
                <div className="text-center mb-20">
                    ...
                    <p className="text-4xl lg:text-5xl font-bold text-primary-dark dark:text-white font-poppins">Kegunaan Indeks Persaingan Usaha</p>
                </div>
