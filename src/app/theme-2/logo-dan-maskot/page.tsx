                            ...
                            <motion.div variants={itemVariants}>
                                <Card className="text-center p-8 bg-background shadow-lg rounded-2xl h-full">
                                    <CardContent className="p-0">
                                        <Eye className="h-12 w-12 text-[#006666] mx-auto mb-6" />
                             ...
                             <motion.div variants={itemVariants}>
                                <Card className="text-center p-8 bg-background shadow-lg rounded-2xl h-full">
                                    <CardContent className="p-0">
                                        <Scale className="h-12 w-12 text-[#006666] mx-auto mb-6" />
                             ...
                             <motion.div variants={itemVariants}>
                                <Card className="text-center p-8 bg-background shadow-lg rounded-2xl h-full">
                                    <CardContent className="p-0">
                                        <Palette className="h-12 w-12 text-[#006666] mx-auto mb-6" />
