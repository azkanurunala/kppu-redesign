            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-16">
              <div className="lg:col-span-3 space-y-10">
                {researchData.map((item, index) => (
                  ...
                  >
                    <Card className="transition-all duration-300 ease-in-out hover:shadow-2xl hover:-translate-y-1.5 border-l-4 border-[#006666] bg-[#1a1a1a]">
                      <CardHeader>
                          <div className="flex items-center text-sm text-gray-300 gap-6 mb-3">
                          ...
                          <CardTitle className="text-2xl font-bold font-poppins text-[#006666]-dark dark:text-white leading-snug hover:text-[#006666] cursor-pointer transition-colors">
                              {item.title}
                          </CardTitle>
                      </CardHeader>
                      <CardContent>
                        <p className="text-gray-300 leading-relaxed mb-6">{item.description}</p>
                        <Button size="lg" variant="outline" className="rounded-full px-6 border-[#006666] text-[#006666] hover:bg-[#006666]/10 hover:text-[#006666]">
              ...
              <aside className="space-y-10 lg:sticky lg:top-28 h-fit">
                <Card className="shadow-lg">
                  <CardHeader>
                    <CardTitle className="flex items-center gap-3 text-xl font-poppins text-[#006666]-dark dark:text-white">
                 ...
                 <Card className="shadow-lg">
                    <CardHeader>
                        <CardTitle className="text-xl font-poppins text-[#006666]-dark dark:text-white">Navigasi Cepat</CardTitle>
                    </CardHeader>
                    <CardContent className="p-0">
                        <nav className="flex flex-col">
                        {sidebarNavItems.map((item, index) => (
                            <Link key={index} href={item.href}>
                              <div className={`flex items-center p-5 cursor-pointer hover:bg-[#006666]/10 transition-colors text-white/80 font-semibold ${index !== sidebarNavItems.length - 1 ? 'border-b border-border/50' : ''}`}>
                                  <item.icon className="h-5 w-5 text-[#006666] mr-4" />
