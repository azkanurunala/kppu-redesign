        ...
        <div className="flex flex-col min-h-screen bg-background text-white overflow-x-hidden">
            ...
            <main className="flex-1">
                ...
                <section className="py-24 lg:py-32">
                    <div className="container mx-auto">
                        <div className="text-center mb-20">
                            <h2 className="text-sm font-bold uppercase tracking-widest text-[#421BBC] mb-4 font-poppins">Periode 2023-2028</h2>
                            <p className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#421BBC]-dark dark:text-white font-poppins">Pimpinan dan Anggota Komisi</p>
                        </div>
                        <motion.div 
                ...
                <section className="py-24 lg:py-32 bg-white/10 backdrop-blur-sm">
                    <div className="container mx-auto">
                        <div className="text-center mb-20">
                            <h2 className="text-sm font-bold uppercase tracking-widest text-[#421BBC] mb-4 font-poppins">Arsip</h2>
                            <p className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#421BBC]-dark dark:text-white font-poppins">Sejarah Keanggotaan KPPU</p>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 max-w-6xl mx-auto">
                            <div>
                                <h3 className="text-2xl font-bold font-poppins text-[#421BBC]-dark dark:text-white mb-8">Anggota Komisi dari Masa ke Masa</h3>
                                <Accordion type="single" collapsible className="w-full space-y-4">
                                    {pastMembers.map((item, index) => (
                                        <AccordionItem key={index} value={`item-${index}`} className="bg-background rounded-lg shadow-md px-2">
                                            <AccordionTrigger className="p-4 text-left font-bold text-lg hover:no-underline text-[#421BBC]-dark dark:text-white">
                                                Periode {item.period}
                                            </AccordionTrigger>
                                            <AccordionContent className="p-4 pt-0 text-white/70">
                            ...
                            <div>
                                 <h3 className="text-2xl font-bold font-poppins text-[#421BBC]-dark dark:text-white mb-8">Ketua & Wakil Ketua dari Masa ke Masa</h3>
                                 <Card className="bg-background shadow-md">
                                     <CardContent className="p-6">
                                         <ul className="space-y-6">
                                            {pastLeaders.map((item, index) => (
                                                <li key={index} className={index !== pastLeaders.length -1 ? "border-b border-border pb-6" : ""}>
                                                    <p className="font-bold text-lg text-[#421BBC]-dark dark:text-white">Periode {item.period}</p>
                                                    <p className="text-white/70 mt-1"><span className="font-semibold">Ketua:</span> {item.chair}</p>
                                                    <p className="text-white/70"><span className="font-semibold">Wakil Ketua:</span> {item.vice}</p>
                                                </li>
                                            ))}
                                         </ul>
                                     </CardContent>
                 ...
                 <section className="py-24 lg:py-32">
                    <div className="container mx-auto">
                         <div className="text-center max-w-4xl mx-auto">
                            ...
                            >
                                <Users className="h-16 w-16 text-[#421BBC] mx-auto mb-6" />
                                <h2 className="text-sm font-bold uppercase tracking-widest text-[#421BBC] mb-4 font-poppins">Integritas dan Profesionalisme</h2>
                                <p className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#421BBC]-dark dark:text-white font-poppins mb-6">Kode Etik Komisi</p>
