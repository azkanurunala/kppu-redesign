  ...
  return (
    <div className="flex min-h-screen flex-col bg-background text-foreground overflow-x-hidden">
      <main className="flex-1">
        ...
        <section className="bg-[#7C3AED] text-white py-20 relative overflow-hidden">
            ...
            <div className="container mx-auto relative z-10 text-center">
                <motion.h1
                    ...
                    className="text-3xl md:text-5xl font-bold font-inter leading-tight"
                >
                ...
                <motion.p
                    ...
                    className="mt-6 text-lg md:text-xl max-w-3xl mx-auto text-white/80 font-inter"
                >
        ...
        <section className="py-4 lg:py-4 bg-purple-100 dark:bg-[#8B5CF6]">
           <div className="container mx-auto">
             <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
               {/* Regulasi */}
               <Link href="/theme-3/regulasi" className="group text-center">
                 <div className="p-6 rounded-xl hover:bg-[#7C3AED]/10 transition-all duration-300">
                   <div className="p-4 bg-[#7C3AED]/10 rounded-full mb-4 mx-auto w-fit">
                     <FileText className="h-8 w-8 text-[#7C3AED]" />
                   </div>
                   <h3 className="text-sm font-bold text-[#7C3AED] font-inter">REGULASI</h3>
                 </div>
               </Link>

               {/* Putusan */}
               <Link href="/theme-3/putusan" className="group text-center">
                 <div className="p-6 rounded-xl hover:bg-[#7C3AED]/10 transition-all duration-300">
                   <div className="p-4 bg-[#7C3AED]/10 rounded-full mb-4 mx-auto w-fit">
                     <Gavel className="h-8 w-8 text-[#7C3AED]" />
                   </div>
                   <h3 className="text-sm font-bold text-[#7C3AED] font-inter">PUTUSAN</h3>
                 </div>
               </Link>

               {/* Jadwal Sidang */}
               <Link href="/theme-3/jadwal-sidang" className="group text-center">
                 <div className="p-6 rounded-xl hover:bg-[#7C3AED]/10 transition-all duration-300">
                   <div className="p-4 bg-[#7C3AED]/10 rounded-full mb-4 mx-auto w-fit">
                     <Scale className="h-8 w-8 text-[#7C3AED]" />
                   </div>
                   <h3 className="text-sm font-bold text-[#7C3AED] font-inter">JADWAL SIDANG</h3>
                 </div>
               </Link>

               {/* Siaran Pers */}
               <Link href="/theme-3/siaran-pers" className="group text-center">
                 <div className="p-6 rounded-xl hover:bg-[#7C3AED]/10 transition-all duration-300">
                   <div className="p-4 bg-[#7C3AED]/10 rounded-full mb-4 mx-auto w-fit">
                     <Megaphone className="h-8 w-8 text-[#7C3AED]" />
                   </div>
                   <h3 className="text-sm font-bold text-[#7C3AED] font-inter">SIARAN PERS</h3>
                 </div>
               </Link>

               {/* Tanya Jawab */}
               <Link href="/theme-3/tanya-jawab" className="group text-center">
                 <div className="p-6 rounded-xl hover:bg-[#7C3AED]/10 transition-all duration-300">
                   <div className="p-4 bg-[#7C3AED]/10 rounded-full mb-4 mx-auto w-fit">
                     <Search className="h-8 w-8 text-[#7C3AED]" />
                   </div>
                   <h3 className="text-sm font-bold text-[#7C3AED] font-inter">TANYA JAWAB</h3>
                 </div>
               </Link>

               {/* PPID */}
               <Link href="/theme-3/ppid" className="group text-center">
                 <div className="p-6 rounded-xl hover:bg-[#7C3AED]/10 transition-all duration-300">
                   <div className="p-4 bg-[#7C3AED]/10 rounded-full mb-4 mx-auto w-fit">
                     <FileText className="h-8 w-8 text-[#7C3AED]" />
                   </div>
                   <h3 className="text-sm font-bold text-[#7C3AED] font-inter">PPID</h3>
                 </div>
               </Link>
             </div>
           </div>
         ...
         {/* About KPPU Section */}
         <section className="py-24 lg:py-32 bg-[#7C3AED]">
           <div className="container mx-auto">
             ...
             <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mb-16">
               <div>
                    <h3 className="text-3xl font-bold font-inter text-white mb-4">Pengawas Persaingan Usaha</h3>
                    ...
                    <Button asChild variant="link" className="p-0 h-auto self-start text-white font-bold font-inter">
         ...
         <section className="py-24 lg:py-32 bg-card">
           <div className="container mx-auto">
             <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
               <div className="">
                 <h2 className="text-4xl md:text-5xl font-bold text-[#7C3AED] dark:text-white font-inter">Kantor Wilayah</h2>
                 <p className="mt-4 text-lg text-muted-foreground leading-relaxed max-w-lg font-inter">
                 ...
                 <Button size="lg" variant="default" asChild className="mt-8 font-inter">
