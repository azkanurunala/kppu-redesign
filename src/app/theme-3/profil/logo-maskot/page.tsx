    ...
    return (
        <div className="flex flex-col min-h-screen bg-background text-white overflow-x-hidden">
            ...
            <main className="flex-1">
                <section
                    className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 text-white bg-gradient-to-br from-purple-900 to-indigo-900"
                >
                            ...
                            <motion.div variants={itemVariants}>
                                <Card className="text-center p-10 bg-background shadow-lg rounded-2xl h-full border-0">
                                    <CardContent className="p-0">
                                        <div className="bg-[#421BBC]/10 rounded-full p-4 inline-block mb-6">
                                            <Eye className="h-10 w-10 text-[#421BBC]" />
                                        </div>
                             ...
                             <motion.div variants={itemVariants}>
                                <Card className="text-center p-10 bg-background shadow-lg rounded-2xl h-full border-0">
                                    <CardContent className="p-0">
                                        <div className="bg-[#421BBC]/10 rounded-full p-4 inline-block mb-6">
                                            <Scale className="h-10 w-10 text-[#421BBC]" />
                                        </div>
                             ...
                             <motion.div variants={itemVariants}>
                                <Card className="text-center p-10 bg-background shadow-lg rounded-2xl h-full border-0">
                                    <CardContent className="p-0">
                                        <div className="bg-[#421BBC]/10 rounded-full p-4 inline-block mb-6">
                                            <Palette className="h-10 w-10 text-[#421BBC]" />
                                        </div>
