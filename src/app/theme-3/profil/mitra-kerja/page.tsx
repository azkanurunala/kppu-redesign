        ...
        <section className="py-24 lg:py-32">
          <div className="container mx-auto">
            <div className="max-w-4xl mx-auto mb-20">
              <h2 className="text-3xl lg:text-4xl font-bold text-[#421BBC]-dark dark:text-white font-poppins mb-6">Sinergi untuk Persaingan Usaha yang Sehat</h2>
            ...
            >
              {partners.map((partner) => (
                <motion.div key={partner.name} variants={itemVariants}>
                  <Card className="h-full flex flex-col items-center justify-center p-6 text-center bg-white/10 backdrop-blur-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 ease-in-out border-border/50 rounded-xl">
