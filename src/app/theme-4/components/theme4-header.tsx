...
const navItems = [
  {
    ...
    href: '/theme-4/profil',
    subItems: [
      { label: 'VISI DAN MISI', href: '/theme-4/profil/visi-misi' },
      ...
      { label: 'MITRA KERJA', href: '/theme-4/profil/mitra-kerja' },
      { label: 'PPID', href: '/theme-4/ppid' },
      { label: 'LOGO DAN MASKOT', href: '/theme-4/profil/logo-dan-maskot' },
    ],
  },
  {
    label: 'REGULASI',
    href: '/theme-4/regulasi',
    subItems: [
        { label: 'UNDANG-UNDANG & PP', href: '/theme-4/regulasi/peraturan-perundang-undangan' },
        { label: 'PERATURAN KOMISI', href: '/theme-4/regulasi/peraturan-komisi' },
        { label: 'PERATURAN KETUA KPPU', href: '/theme-4/regulasi/peraturan-ketua-kppu' },
        { label: 'PEDOMAN', href: '/theme-4/regulasi/pedoman' },
        { label: 'PUTUSAN', href: '/theme-4/penindakan/perkara-persaingan' },
    ]
  },
  {
    label: 'PENGAWASAN',
    ...
    subItems: [
        ...
        { label: 'INDEKS PERSAINGAN USAHA', href: '/theme-4/indeks-persaingan-usaha' },
        { label: 'KPPU MENDENGAR', href: '/theme-4/kppu-mendengar' },
    ]
  },
    {
    label: 'PENINDAKAN',
    ...
    subItems: [
        ...
        { label: 'PENILAIAN MERGER', href: '/theme-4/penindakan/penilaian-merger' },
        { label: 'PENGAWASAN KEMITRAAN', href: '/theme-4/penindakan/pengawasan-kemitraan' },
    ]
  },
  {
    label: 'PUBLIKASI',
    href: '/theme-4/publikasi',
    subItems: [
        { label: 'AKTIVITAS', href: '/theme-4/publikasi/aktivitas' },
        { label: 'SIARAN PERS', href: '/theme-4/publikasi/siaran-pers' },
        { label: 'LAPORAN TAHUNAN', href: '/theme-4/publikasi/laporan-tahunan' },
        { label: 'JURNAL', href: '#' },
    ]
  },
  {
  ...
  { label: 'E-PROCUREMENT', href: '/theme-4/e-procurement' },
  { label: 'KONTAK', href: '/theme-4/contact' },
];
  ...
  return (
    <>
      <header className={cn(
        ...
        isScrolled ? "bg-[#450d0d] shadow-md backdrop-blur-lg" : "bg-[#450d0d]"
      )}>
        <div className="container mx-auto flex h-20 items-center justify-between px-4">
          <Link href="/theme-4" className="flex items-center gap-2">
            <LogoImage />
          </Link>
          ...
          <div className="flex items-center gap-1">
            ...
            <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
              ...
              <SheetContent side="right" className="w-full max-w-sm bg-background">
                 <SheetHeader>
                  <SheetTitle>
                    <Link href="/theme-4" onClick={() => setIsMobileMenuOpen(false)}>
                      <LogoImage />
                    </Link>
                  </SheetTitle>
                </SheetHeader>
